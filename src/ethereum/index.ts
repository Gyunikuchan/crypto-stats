...
// import { ETH_BLOCKS_SOURCE_URL, EthereumBlockManager } from "./eth.block.manager";
...
function printPeriodStats(blockManager: EthBlockManager, startMoment: moment.Moment, endMoment: moment.Moment) {
